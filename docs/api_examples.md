...
Отправка действия игрока и получение ответа от AI Dungeon Master с использованием RAG.
...
```json
{
  ...
  "message": "Кастую Fireball на группу орков"
}
```
...
```json
{
  "response": "Вы произносите заклинание и указываете на группу орков. Магический огонь концентрируется в вашей руке и вырывается наружу, превращаясь в огненный шар диаметром 20 футов. Все существа в области действия должны сделать спасбросок Ловкости (Сл 15).",
  "action_id": 1,
